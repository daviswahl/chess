...
/***/ function(module, exports, __webpack_require__) {
	            ...
	            switch (this.props.piece.type) {
	                case "King":
	                    return _react2.default.createElement(
	                        'div',
	                        { style: { float: "left", color: this.props.piece.color } },
	                        'K'
	                    );
	                case "Queen":
	                    return _react2.default.createElement(
	        ...
	        value: function render() {
	            if (this.props.color == "black") {
	                return _react2.default.createElement(
	                    'div',
	                    { style: blackTile },
	                    _react2.default.createElement(Piece, { piece: this.props.piece })
	                );
	...
	var Row = function (_React$Component3) {
	    ...
	    _createClass(Row, [{
	        key: 'pieceForCol',
	        value: function pieceForCol(col) {
	            var cl = col;
	            return this.props.tiles.filter(function (elem) {
	                return elem.position.column == cl;
	            })[0].piece;
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            if (this.props.alt == true) {
	                return _react2.default.createElement(
	                    'div',
	                    { className: 'row' },
	                    _react2.default.createElement(Tile, { row: this.props.row, col: 'A', piece: this.pieceForCol("A"), color: 'black' }),
	                    _react2.default.createElement(Tile, { row: this.props.row, col: 'B', piece: this.pieceForCol("B"), color: 'white' }),
	                    _react2.default.createElement(Tile, { row: this.props.row, col: 'C', piece: this.pieceForCol("C"), color: 'black' }),
	                    _react2.default.createElement(Tile, { row: this.props.row, col: 'D', piece: this.pieceForCol("D"), color: 'white' }),
	                    _react2.default.createElement(Tile, { row: this.props.row, col: 'E', piece: this.pieceForCol("E"), color: 'black' }),
	                    _react2.default.createElement(Tile, { row: this.props.row, col: 'F', piece: this.pieceForCol("F"), color: 'white' }),
	                    _react2.default.createElement(Tile, { row: this.props.row, col: 'G', piece: this.pieceForCol("G"), color: 'black' }),
	                    _react2.default.createElement(Tile, { row: this.props.row, col: 'H', piece: this.pieceForCol("H"), color: 'white' })
	                );
	            } else {
	                return _react2.default.createElement(
	                    'div',
	                    { className: 'row' },
	                    _react2.default.createElement(Tile, { row: this.props.row, col: 'A', piece: this.pieceForCol("A"), color: 'white' }),
	                    _react2.default.createElement(Tile, { row: this.props.row, col: 'B', piece: this.pieceForCol("B"), color: 'black' }),
	                    _react2.default.createElement(Tile, { row: this.props.row, col: 'C', piece: this.pieceForCol("C"), color: 'white' }),
	                    _react2.default.createElement(Tile, { row: this.props.row, col: 'D', piece: this.pieceForCol("D"), color: 'black' }),
	                    _react2.default.createElement(Tile, { row: this.props.row, col: 'E', piece: this.pieceForCol("E"), color: 'white' }),
	                    _react2.default.createElement(Tile, { row: this.props.row, col: 'F', piece: this.pieceForCol("F"), color: 'black' }),
	                    _react2.default.createElement(Tile, { row: this.props.row, col: 'G', piece: this.pieceForCol("G"), color: 'white' }),
	                    _react2.default.createElement(Tile, { row: this.props.row, col: 'H', piece: this.pieceForCol("H"), color: 'black' })
	                );
	            }
	        }
	    }]);
	...
	var Board = function (_React$Component4) {
	    ...
	    _createClass(Board, [{
	        key: 'tilesForRow',
	        value: function tilesForRow(row) {
	            var rw = row;
	            return this.props.tiles.filter(function (elem) {
	                return elem.position.row == rw;
	            });
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'container' },
	                _react2.default.createElement(Row, { row: 'One', tiles: this.tilesForRow("One") }),
	                _react2.default.createElement(Row, { row: 'Two', tiles: this.tilesForRow("Two"), alt: true }),
	                _react2.default.createElement(Row, { row: 'Three', tiles: this.tilesForRow("Three") }),
	                _react2.default.createElement(Row, { row: 'Four', tiles: this.tilesForRow("Four"), alt: true }),
	                _react2.default.createElement(Row, { row: 'Five', tiles: this.tilesForRow("Five") }),
	                _react2.default.createElement(Row, { row: 'Six', tiles: this.tilesForRow("Six"), alt: true }),
	                _react2.default.createElement(Row, { row: 'Seven', tiles: this.tilesForRow("Seven") }),
	                _react2.default.createElement(Row, { row: 'Eight', tiles: this.tilesForRow("Eight"), alt: true })
	            );
	        }
	    }]);
	...
	req.addEventListener("load", function (evt, req) {
	    ...
	    _reactDom2.default.render(_react2.default.createElement(Board, { tiles: tiles.tiles }), document.getElementById('board'));
	});
